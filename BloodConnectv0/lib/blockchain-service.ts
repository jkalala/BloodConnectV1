...
export class BlockchainService {
   ...
   */
  async trackBloodRequest(requestData: any): Promise<void> {
    const metadata = {
   ...
   */
  async trackDonorResponse(responseData: any): Promise<void> {
    const metadata = {
   ...
   */
  async trackDonationCompletion(completionData: any): Promise<void> {
    const metadata = {
   ...
   */
  async trackVerification(verificationData: any): Promise<void> {
    const metadata = {
