...
export class SecurityMonitor {
   ...
   */
  async trackUserActivity(userId: string, activity: string, details: Record<string, any> = {}): Promise<void> {
...
export const trackUserActivity = (userId: string, activity: string, details?: Record<string, any>) => 
