...
export class WhatsAppService {
  ...
  public async sendBloodRequestNotification(request: any, donorPhone: string): Promise<boolean> {
    try {
  ...
  public async sendEmergencyAlert(alert: any, donorPhone: string): Promise<boolean> {
    try {
      const message: WhatsAppMessage = {
        to: donorPhone,
        type: 'interactive',
  ...
  public async sendDonorMatchNotification(request: any, donor: any): Promise<boolean> {
    try {
      const message: WhatsAppMessage = {
  ...
  public async sendDonationReminder(user: any): Promise<boolean> {
    try {
      const message: WhatsAppMessage = {
        to: user.phone,
        type: 'interactive',
  ...
  public async sendWelcomeMessage(user: any): Promise<boolean> {
    try {
      const message: WhatsAppMessage = {
        to: user.phone,
        type: 'text',
  ...
  private async handleAvailabilityUpdate(user: any, available: boolean): Promise<void> {
    try {
...
Please send all information in one message.`
  ...
  private async sendRequestStatus(to: string, user: any): Promise<void> {
    try {
  ...
  public async broadcastEmergencyAlert(alert: any, bloodType: string): Promise<number> {
    try {
