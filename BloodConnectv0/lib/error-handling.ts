...
export const ValidationError = (message: string, details?: any, userId?: string) =>
...
export const InternalError = (message: string = 'Internal server error', details?: any, userId?: string) =>
